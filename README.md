...
```javascript
sdsnanmeanors = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sdsnanmeanors@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sdsnanmeanors@umd/bundle.js"></script>
```
